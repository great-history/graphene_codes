...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%　数据保存为hdf5格式                 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% h5create('D:/matlab/graphene-package/三层数据/data_pack.h5','/figures/figure3/figure3a',[101 3],'Datatype','double');
% h5write('D:/matlab/graphene-package/三层数据/data_pack.h5','/figures/figure3/figure3a', [mag_field_before', select_Cxx_B_before, select_Cxx_B_after]);
% h5disp('D:/matlab/graphene-package/三层数据/data_pack.h5')