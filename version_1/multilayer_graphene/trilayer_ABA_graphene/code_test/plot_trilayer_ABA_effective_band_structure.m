...
subplot(1,2,1);
for i = 2
    plot(akxs,eig_enes_K(:,center_y,i),'r', 'LineWidth', 2)
    hold on;
    plot(akys,eig_enes_K(center_x,:,i),'r--','LineWidth', 2)
    hold on
end

for i = 3
    plot(akxs,eig_enes_K(:,center_y,i), 'b', 'LineWidth', 2)
    hold on;
    plot(akys,eig_enes_K(center_x,:,i), 'b--', 'LineWidth', 2)
    hold on
end
