...
% 得到的拟合结果为   3.1000    0.3862   -0.0241    0.2200    0.0348    0.0623    0.0400    0.0010
% 得到的拟合结果为   3.1000    0.3862   -0.0240    0.2200    0.0348    0.0621    0.0399    0.0010


% [x1, x1_down, x1_up] = get_error_bar(x0, ydata, error, turn_on, B_error);
% 得到的拟合结果为      x1 = 3.1000    0.3862   -0.0240    0.2200    0.0348    0.0621    0.0399    0.0010
% 得到的拟合结果为 x1_down = 3.1000    0.3857   -0.0227    0.3000    0.0439    0.0634    0.0400    0.0010
% 得到的拟合结果为   x1_up = 3.1000    0.3873   -0.0253    0.1000    0.0280    0.0608    0.0398    0.0011
