...
parfor ii = 1:num_test
    ...
    [output_value_list, fval,exitflag,output,lambda,grad,hessian] = fmincon(@trilayer_ABA_LLs_0GPa_fitting_without_D_fmincon, initial_value_list, A, b, Aeq, beq, lb_list, ub_list);
    toc
...
% function [c,ceq] = nonlcon(hopping_params, ene_width_disorder)
