function LL_m0_crossing_points_list = trilayer_ABA_LLs_fitting_without_D_lsq(hopping_params, input_index_list)
    ...
    ene_width_disorder = 0.0015; % 假设有2meV的disorder带来的能量展开
    % 要求LL_Kp_m0与LL_K_m0之间的能量间隔应小于ene_width_disorder
    if abs(LL_K_m_0 - LL_Kp_m_0) > ene_width_disorder
        LL_m0_crossing_points_list = 10 * B_start * ones(1, 6); % 这句话不好
    else
