function sse_crossing_points = trilayer_ABA_LLs_0GPa_fitting_without_D_fmincon(hopping_params)
    %% 使用fmincon进行参数的优化
    ...
    ene_width_disorder = 0.0008; % 假设有2meV的disorder带来的能量展开
    ...
    B_cross2_min_exp = 4.40;
    % 对应LL_m_0与LL_b_K_3和LL_b_Kp_3之间的交叉点位置
    B_cross3_max_exp = 2.50;
