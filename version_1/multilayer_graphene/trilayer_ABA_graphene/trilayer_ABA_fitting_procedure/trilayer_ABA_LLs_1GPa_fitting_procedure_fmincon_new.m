...
lb_list = [3.1; 0.380; -0.035;  0.25;  0.046; 0.06;  0.04; 0.0]; % gamma0 / gamma1 / gamma2 / gamma3 / gamma4 / gamma5 / delta / Delta2
ub_list = [3.1; 0.400; -0.010;  0.55;  0.086; 0.10;  0.06; 0.005];
...
for ii = 1:num_test
    ...
    [output_value_list, fval, exitflag, output, lambda, grad, hessian] = fmincon(@trilayer_ABA_LLs_1GPa_fitting_without_D_fmincon_new, initial_value_list, A, b, Aeq, beq, lb_list, ub_list);
    toc
