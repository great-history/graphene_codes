...
hold on
plot(B_fields, LL_K_b(:, LL_K_b_positive_indexs(2)), 'c', 'LineWidth', 1.5)
hold on
plot(B_fields, LL_Kp_b(:, LL_Kp_b_positive_indexs(2)), 'c', 'LineWidth', 1.5)  % 对于bilayer，这些解析得到的低能LL一般不能与数值计算得到的结果完全吻合，会有1meV左右的偏差
...
title('Landau Fan @ 0GPa','interpreter','latex', 'FontSize', 24);
