function H_hf_spin = construct_ABC_trilayer_H_hf_spin(density_matrix, exchange_integrals_intralayer_cell, exchange_integrals_interlayer_cell, E_exchange, E_H, E_zeeman)
    % 构造关于ABC trilayer graphene的full Hartree-Fock Hamiltonian(仅构造一个自旋方向，另一个不构造)
        ...
        for m2 = 0:2
            ...
            for m1 = 0:2
                for n2 = 0:2
                    ...
                    % B3产生 A1湮灭
                    val_B3A1_up = val_B3A1_up + exchange_integral_intralayer * density_matrix_up(m1 + 4, n2 + 1);
                    val_B3A1_down = val_B3A1_down + exchange_integral_intralayer * density_matrix_down(m1 + 4, n2 + 1);
                end
            end
